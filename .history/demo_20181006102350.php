            ...
            <div class="card-body px-lg-5 pt-0">
                ...
                <form class="text-center" style="color: #757575;">
                    ...
                    <div class="col-md-3">
                        ...
                        <h6>Upload Proof of identity</h6>
                        
                        
                        <div class="col-md-12">
                        <input type="file" class="form-control"  name="poi" class="col-md-8" style="float:left; padding:5px;/">
                        <br><br>
                    ...
                    <div class="col-md-3">
                        ...
                        <h6>Upload Proof of address</h6>
                        
                        
                        <div class="col-md-12">
                        <input type="file" class="form-control"  name="poa" class="col-md-8" style="float:left; padding:5px;/">
                        <br><br>
